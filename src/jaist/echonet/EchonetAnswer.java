...
/**
 * Represents the answer to an ECHONET query
 * 
...
public class EchonetAnswer {
     ...
     * requests to return the results for the properties that where specified
     * as the GET part of the query. Otherwise is null
     */
    public EchonetAnswer(
            Query query, 
            RemoteEchonetObject responder,
    ...
    /**
     * Gets the secondary list in the case of a SETGET query.  
     * This is the GET list of properties in the case of
     * this answer being an answer to a SETGET query. Otherwise it is null. The
     * SET results are accessible through the {@link EchonetAnswer#getProperties() }
     * method
     * 
     ...
     * the result of <code>System.currentTimeMillis()</code> that is called 
